...
<body>
    ...
    <?php
        ...
        if($month>2 && $month<6){
            //봄
            $bg_img_url = "https://cdn.pixabay.com/photo/2016/02/27/06/43/cherry-tree-1225186__340.jpg";
        }
        elseif($month>5 && $month<9){
            //여름
            $bg_img_url = "http://mblogthumb2.phinf.naver.net/20150702_121/earthtory1_1435802993804yd7QM_JPEG/saipan-beach1.jpg?type=w2";
        }
        elseif($month>8 && $month<11){
            //가을
            $bg_img_url = "http://www.lecturernews.com/news/photo/201809/7079_18292_5658.jpg";
        }
        else{
            //겨울
            $bg_img_url = "https://hokkaido-labo.com/wp-content/uploads/2014/12/mildseven-hill-winter.jpg";
        }
    ?>
